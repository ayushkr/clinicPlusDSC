...
import in.srisrisri.clinic.utils.FileUtils;
import in.srisrisri.clinic.utils.FolderUtils;
import in.srisrisri.clinic.Document.Document;
...
public class FileService {
    ...
    public void doNeedful(String spring_boot_tutorial_line, SearchResponse searchResponse) {
        ...
        _1_2_etc_list.forEach(_1 -> {
            ...
            searchResponse.getResultOfSearchList().add(resultOfSearch);
        });
